...
/*
//A separate factory decides which plug to provide
class PlugFactory {
 public static AmericanPlug getUniversalPlug() {
     // This factory internally creates the adaptee and wraps it in the adapter
     EuropeanPlug rawPlug = new EuropeanPlug();
     return new PlugAdapter(rawPlug);
 }
}
//Revised Client Code (Cleaner interaction)
public class AdapterExample {
 public static void main(String[] args) {
     // The client only deals with the target interface
     AmericanPlug plug = PlugFactory.getUniversalPlug();
     plug.connect();
 }
}
*/
